...
- Data cleaning, EDA, and feature engineering using **Python (Jupyter Notebook)**
- KPI creation and interactive visualization using **Power BI**
- Designed dashboards to analyze:
  - Customer engagement
  - Deposits and loans
...
- Account balances (Deposits, Savings, Checking, Credit Cards)
...
- Created **Engagement Length** using joining date
- Derived **Engagement Timeframe** buckets
...
- Nationality-wise loan distribution
